...
```{r functions-well_being, results="hide"}

tidyWellBeing <- function(df) {
...
wellbeing_df <- read.csv(cfpb_url)
wellbeing_df <- tidyWellBeing(wellbeing_df)
...
ggpairs(wellbeing_df, columns = c("gender", "age_7cat", "state", "metro", "marital_status" ,"cfpb_score"))
...
ggpairs(fed_df, 
        columns = c("gender", "age", "state", "metro", "marital_status" ,"cfpb_score"),
        cardinality_threshold=NULL
        )


ggpairs(fed_df, 
        columns = c("gender", "age", "cfpb_score"),
        cardinality_threshold=NULL
        )
