...
cfpb_df <- slice_sample(cfpb_df, weight_by=cfpb_score_4cat ,n=1000) 
...
ggplot(data = t1,
  ...
  labs(title = 'CFPB Score Neural Net (Actual vs Prediction) ',
       x = 'Predicted',
       y = 'Actual')
...
ggplot(data = t1) +
  ...
  labs (title = "CFPB Score Neural Net (Std Error)")
...
ggplot(t1,
    ...
    labs(title = "CFPB Score (Std Error)")
...
ggplot(data = t2,
  ...
  geom_point(color = '#006EA1') +
  geom_abline(intercept = 0, slope = 1, color = 'orange') +    
  labs(title = 'CFPB Score Neural Net (5 hidden layers) ',
       x = 'Predicted',
       y = 'Actual')
...
# reduce cfpb dataset
fed_df <- slice_sample(fed_df, weight_by=cfpb_score_4cat ,n=1000) 
...
ggplot(data = t1,
  ...
  geom_point(color = '#006EA1') +
  geom_abline(intercept = 0, slope = 1, color = 'orange') +    
  labs(title = 'FED CFPB Score Neural Net (Std Error) ',
       x = 'Predicted',
       y = 'Actual')
...
ggplot(t1,
    ...
    geom_vline(aes(xintercept = mean(diff)), linetype = "dashed", size = 0.8, color="red") +
    scale_fill_brewer(palette="Spectral") +
    labs(title = "FED CFPB Score (Std Error)")
...
ggplot(data = t2,
  ...
  geom_point(color = '#006EA1') +
  geom_abline(intercept = 0, slope = 1, color = 'orange') +    
  labs(title = 'FED CFPB Score Neural Net (5 hidden layers) ',
       x = 'Predicted',
       y = 'Actual')
